...
const STEP_TIMINGS = [
  ...
  { value: 'effect_confirm',    label: '⚡ 効果確認ダイアログの前',        trigger: 'effect_confirm',
    availableIn: ['main','opp_main','opp_breed','trg_before_opponent_turn','trg_turn_end_opp','breed','draw','unsuspend'] },
  { value: 'target_selection',  label: '🎯 対象選択画面の前',              trigger: 'target_selection',
    availableIn: ['main','opp_main','trg_before_opponent_turn','trg_turn_end_opp','breed'] },

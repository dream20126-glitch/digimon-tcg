...
const CONDITION_TYPES = [
  ...
  { value: 'use_effect',         label: '効果を使った/対象選択完了',                  needsCardNo: false, group: '✨ 効果' },
...
const STEP_TIMINGS = [
  ...
  { value: 'target_selection',  label: '🎯 対象選択画面の前',              trigger: 'target_selection',
    availableIn: ['main'] },
  { value: 'opp_target_selection', label: '🎯 対象選択画面の前（相手のターン）', trigger: 'opp_target_selection',
    availableIn: ['opp_main'] },
...
window.executeTutorialScenarioSave = async function() {
  ...
  const initialBoard = {
    ...
    playerTamerArea:     ibState.playerTamerArea    || [],
    ...
    opponentTamerArea:   ibState.opponentTamerArea  || [],

...
import { doPlay, offerAssemblyThenPlay, doEvolve, doEvolveIku, doLink, canEvolveOnto, startAttack, cancelAttack, resolveAttackTarget, battleVictory, battleDefeat, showPlayEffect, showEvolveEffect, showDestroyEffect, showSecurityCheck, showBattleResult, showOptionEffect, setCombatHooks, aiScriptPlayCard, aiScriptEvolveBattle, aiScriptEvolveBreed, aiScriptMoveToBattle, aiScriptAttack } from './battle-combat.js';
...
export function makeEffectContext(card, side) {
  ...
  return {
    ...
    showDrawEffect, showOptionEffect,
  };
}
...
export function setupCommonWindowExports() {
  ...
  window.offerAssemblyThenPlay = offerAssemblyThenPlay;

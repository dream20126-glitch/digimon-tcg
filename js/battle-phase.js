...
import { bs, spendMemory, addMemory, endTurnManual, isMemoryOverflow, drawCards, isDeckEmpty } from './battle-state.js?v=20260411a';
import { addLog, showOverlay, removeOverlay } from './battle-ui.js?v=20260411a';
import { renderAll, renderHand, updateMemGauge, updatePhaseBadge, cardImg } from './battle-render.js?v=20260411a';
import { expireBuffs as _expireBuffs, applyPermanentEffects as _applyPermanent } from './effect-engine.js?v=20260411a';

...
export const TRIGGERS: DictEntry[] = [
  ...
  { code: 'when_battle_destroy', kind: 'trigger', label: 'バトルで消滅するとき（消滅前・置換効果用）' },
  { code: 'on_battle_win', kind: 'trigger', label: 'バトル勝利時' },
  { code: 'when_destroy', kind: 'trigger', label: '消滅するとき（消滅前・置換効果用）' },
  ...
  { code: 'when_opp_evo_discard', kind: 'trigger', label: '相手のデジモンの進化元を破棄したとき' },
  // ターン境界
